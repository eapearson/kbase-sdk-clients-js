/*global define */
/*jslint white:true */
define(['kb/ajax', 'request-promise'], function (ajax, request) {
    "use strict";
    ...
    function Catalog(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
        ...
        function json_call_ajax(method, params, numRets, authToken) {
            var rpc = {
                params: params,
                method: method,
                version: "1.1",
            ...
            return request({
                ...
                .then(function (body) {
                    return JSON.parse(body).result[0];
                });
        }

        function json_call_ajaxx(method, params, numRets, authToken) {
            var rpc = {
                params: params,
                method: method,
                version: "1.1",
            ...
            console.log('Sending to ', _url, header, data);
